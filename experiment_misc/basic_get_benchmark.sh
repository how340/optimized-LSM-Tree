...
modes=1
threads=('8')
leveling_partitions=10

# Base directory for output files
output_dir="./experiment_results"
mkdir -p $output_dir

postix="_get_compare_bit_array_check"
# Output file location
output_file="experiment_results/basic_get_benchmark$postix.txt"
# Ensure the output file is empty before starting
> "$output_file"

# Performance data file
iostat_data_file="experiment_results/iostat$postix.txt"
vmstat_data_file="experiment_results/vmstat$postix.txt"
...
for ((i = 0; i <= 5; i++))
do
    ./workloads/generator --puts $((2**(i+20))) --seed $RANDOM > ./workloads/workload_${i}.txt
done
